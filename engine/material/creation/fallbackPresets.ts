    ...
    凡品: [
      {
        name: '纳息残卷',
        description:
          '卷中文字残缺但脉络尚清，记录了基础吐纳与守神窍门，炼气修士按图修持，仍可缓慢打牢最初修行根底。',
        element: '土',
      },
    ],
    灵品: [
      {
        name: '归脉旧抄',
        description:
          '抄本来源不详却条理完整，重点讲解经络温养与灵息回环，筑基修士长期参照，可提升日常修行稳定程度。',
        element: '木',
      },
    ],
    玄品: [
      {
        name: '洞府札录',
        description:
          '札录汇集多位古修闭关心得，偏重周天细节与灵力调息，结丹修士研读后，常能修正自身运转中的隐患。',
        element: '水',
      },
    ],
    真品: [
      {
        name: '散修秘典',
        description:
          '典中多为实战磨出的行功法门，兼顾调息与应变，元婴修士据此改良自身体系，可增强持续作战与恢复效率。',
        element: '火',
      },
    ],
    地品: [
      {
        name: '上古断篇',
        description:
          '断篇虽缺失关键章节，却保留高阶道痕注解，化神修士细研后仍可借其完善心法框架，并减少突破时的偏差。',
        element: '冰',
      },
    ],
    天品: [
      {
        name: '玄门佚典',
        description:
          '佚典记述失传宗门的复合行功路径，炼虚修士若能逐段参悟，可在多属性并行修持时维持灵力平衡与纯度。',
        element: '雷',
      },
    ],
    仙品: [
      {
        name: '太初遗书',
        description:
          '遗书仅存零散页卷，却字字藏有本源推演痕迹，合体修士观读后可启发悟道方向，并重塑长期闭关策略。',
        element: '风',
      },
    ],
    神品: [
      {
        name: '混元秘藏',
        description:
          '秘藏以古禁制封缄，内容涉及极高层次修行统合之法，渡劫修士若得其真义，可在天劫前进一步凝练大道雏形。',
        element: '雷',
      },
    ],
  },
